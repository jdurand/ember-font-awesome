...
module.exports = class FaIconComponent extends BuildTimeComponent {
  constructor(node, opts = {}) {
    super(opts.transform.syntax, node, Object.assign({ tagName: 'i', ariaHidden: true }, opts));
    ...
    this.iconContent = interpolateProperties(this._syntax.builders, 'fa-:icon:', { callback: trackIcons })
    this.pullContent = interpolateProperties(this._syntax.builders, 'fa-pull-:pull:')
    this.rotateContent = interpolateProperties(this._syntax.builders, 'fa-rotate-:rotate:')
    this.flipContent = interpolateProperties(this._syntax.builders, 'fa-flip-:flip:')
    this.styleContent = interpolateProperties(this._syntax.builders, 'color:$color$', { divisor: '$', skipIfMissingDynamic: true })
  }
